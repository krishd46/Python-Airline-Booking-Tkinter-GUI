...
Label(fr2,text="Mini-Project By:-",font=("algerian",38),compound="center",fg="Orange").pack()
Label(fr2,text="Krish Desai Roll No:9",font=("Bauhaus 93",14),fg="Red",compound="center").pack()
Label(fr2,text="Harsh Chudasama Roll No:7",font=("Bauhaus 93",14),fg="Red",compound="center").pack()
Label(fr2,text="Rishi Gupta Roll No:15",font=("Bauhaus 93",14),fg="Red",compound="center").pack()
Label(fr2,text="Yash Bhanushali Roll No:5",font=("Bauhaus 93",14),fg="Red",compound="center").pack()
...
def airline():
    ...
    w = OptionMenu(root1, variable, "Delhi", "Kolkata", "Mumbai","U.S.A","UK")
    ...
    w = OptionMenu(root1, variable1, "Delhi", "Kolkata", "Mumbai","U.S.A","UK")
    ...
    def signup():
                 def success():
                    ...
                    if a != []:
                          ...
                          showinfo('Signed Up',"Congratulations! You have successfully Signed Up")
                          con.commit()
    ...
    def flights():
        ...
        if variable.get()=="Delhi" and variable1.get()=="U.S.A":
            showerror('Oops!',"Sorry No direct flights available for this route")
        if variable.get()=="Delhi" and variable1.get()=="UK":
            Label(root1,text="Number of Seats Available are:",font=("Bauhaus 93",14),fg="white",bg="orange").grid(row=5,columnspan=4)
        ...
        if variable.get()=="Kolkata" and variable1.get()=="UK":
            showerror('Oops!',"Sorry No direct flights available for this route")
        ...
        if variable.get()=="Mumbai" and variable1.get()=="UK":
            Label(root1,text="Number of Seats Available are:",font=("Bauhaus 93",14),fg="white",bg="orange").grid(row=5,columnspan=4)
        ...
        if variable.get()=="U.S.A" and variable1.get()=="Kolkata":
            Label(root1,text="Number of Seats Available are:",font=("Bauhaus 93",14),fg="white",bg="orange").grid(row=5,columnspan=4)
            Label(root1,text="115",font=("Bauhaus 93",14),fg="white",bg="green").grid(row=5,columnspan=4,column=2)
        if variable.get()=="U.S.A" and variable1.get()=="UK":
            Label(root1,text="Number of Seats Available are:",font=("Bauhaus 93",14),fg="white",bg="orange").grid(row=5,columnspan=4)
            Label(root1,text="168",font=("Bauhaus 93",14),fg="white",bg="green").grid(row=5,columnspan=4,column=2)
        if variable.get()=="UK" and variable1.get()=="Delhi":
            Label(root1,text="Number of Seats Available are:",font=("Bauhaus 93",14),fg="white",bg="orange").grid(row=5,columnspan=4)
            Label(root1,text="201",font=("Bauhaus 93",14),fg="white",bg="green").grid(row=5,columnspan=4,column=2)
        if variable.get()=="UK" and variable1.get()=="Mumbai":
            Label(root1,text="Number of Seats Available are:",font=("Bauhaus 93",14),fg="white",bg="orange").grid(row=5,columnspan=4)
            Label(root1,text="160",font=("Bauhaus 93",14),fg="white",bg="green").grid(row=5,columnspan=4,column=2)
        if variable.get()=="UK" and variable1.get()=="Kolkata":
           showerror('Oops!',"Sorry No direct flights available for this route")
        if variable.get()=="UK" and variable1.get()=="U.S.A":
            Label(root1,text="Number of Seats Available are:",font=("Bauhaus 93",14),fg="white",bg="orange").grid(row=5,columnspan=4)
            Label(root1,text="168",font=("Bauhaus 93",14),fg="white",bg="green").grid(row=5,columnspan=4,column=2)
